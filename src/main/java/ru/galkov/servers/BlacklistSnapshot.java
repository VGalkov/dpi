...
public final class BlacklistSnapshot {
    ...
    public BlacklistSnapshot(Set<String> domains, Set<String> ips) {
        this.domains = Collections.unmodifiableSet(domains);
        this.ips = Collections.unmodifiableSet(ips);
    }

    public static BlacklistSnapshot empty() {
        return new BlacklistSnapshot(Collections.<String>emptySet(), Collections.<String>emptySet());
    }
